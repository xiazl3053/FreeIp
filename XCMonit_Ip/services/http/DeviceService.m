...
{
    NSString *strUrl = [[NSString alloc] initWithFormat:@"%@index.php?r=service/service/GetDrviceInfo&session_id=%@&index=%d&count=%d",NSLocalizedString(@"httpserver","http service"),[UserInfo sharedUserInfo].strSessionId,nIndex,nCount];
    DLog(@"strUrl:%@",strUrl);
