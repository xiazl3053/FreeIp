...
typedef struct DSC_NETWORK_INFO{
    unsigned int   ulMemberIsValid;                       /*成员有效性*/
    ...
    unsigned char   ucMacAddr[DSC_MACADDR_LEN];            /*mac 地址: 例如 A1:B2:C3:D4:E5:F6 前12位有效.剩下4位填0*/
...
typedef struct DSC_DEV_INFO{
    ...
    unsigned int   ulHttpPort;                            /*http 端口*/
    unsigned int   ulRtspPort;                            /*rtsp 端口*/
    unsigned int   ulTcpPort;                             /*tcp  端口*/
    unsigned int   ulPlaybackPort;                        /*回放 端口*/
    unsigned int   ulPrivatePort;                         /*私有协议端口(DVR Server端口)*/
...
typedef struct DSC_PLATFORM_INFO{
    ...
    unsigned int   ucPlatformType;                                                /*平台类型: 填写 DSC_PLATFORM_XXX*/
...
typedef struct DSC_SEARCH_RESPONSE_OINFO{
    ...
    unsigned int   ulDevModel;
    unsigned int   ulHttpPort;                            /*网页端口*/
    unsigned int   ulRtspPort;                            /*rtsp 端口*/
    unsigned int   ulMobilePort;
    unsigned int   ulTcpPort;                             /*tcp 端口*/
    unsigned int   ulPlaybackPort;                        /*回放 端口*/
